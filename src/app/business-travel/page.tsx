...
export default function BusinessTravelPage() {
  ...
  const handlePersonalTravelClick = () => {
    router.push('/welcome')
  }
      ...
      <section className="relative h-96 bg-gray-800 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white space-y-8">
          ...
          <div className="flex items-center justify-center gap-1">
            <Button className="bg-[#eda92c] text-white rounded-full px-6 py-2 text-sm font-medium">
              <Building2 className="w-4 h-4 mr-2" />
              Business Travel
            </Button>
            <Button
              variant="outline"
              className="bg-black/80 border-white text-white rounded-full px-6 py-2 text-sm font-medium hover:bg-black/60"
              onClick={handlePersonalTravelClick}
            >
          ...
          {/* Enhanced Search Bar with Date Pickers */}
          <div className="flex items-center max-w-4xl mx-auto bg-white rounded-full p-1 shadow-lg">
            ...
            <div className="flex items-center px-4 border-l border-gray-200">
              <div className="text-left">
                ...
                <div className="text-sm text-gray-700">Select Date</div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto">
                  <Eye className="w-6 h-6 text-[#316db4]" />
                </div>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mx-auto">
                  <MapIcon className="w-6 h-6 text-[#eda92c]" />
                </div>
                <h3 className="font-semibold text-[#2a2b2f]">Travel</h3>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto">
                  <BookOpen className="w-6 h-6 text-[#316db4]" />
                </div>
                <h3 className="font-semibold text-[#2a2b2f]">Booking</h3>
                <p className="text-sm text-gray-600">Manager trip</p>
              </CardContent>
            </Card>
