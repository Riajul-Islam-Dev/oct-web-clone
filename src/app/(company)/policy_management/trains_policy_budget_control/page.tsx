...
// Sample trains budget control data
const trainsBudgetControlData = [
  {
    id: 1,
...
export default function TrainsBudgetControlPage() {
  return (
    <Sheet>
      <div className="px-4 py-4 flex-1">
        <div className="flex justify-between items-center mb-4">
          <div className="flex flex-col">
            <h4 className="text-lg font-ubuntu">Trains Budget Control</h4>
            <p className="text-sm font-raleway font-medium">
              Define Policy levels and approval rules for train travel in your organization.
            </p>
          </div>
        ...
        <BudgetControlTable data={trainsBudgetControlData} />
      </div>
