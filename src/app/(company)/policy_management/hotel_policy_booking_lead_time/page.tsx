...
// Sample data for hotel booking lead time policies
...
export default function HotelBookingLeadTimePage() {
      ...
      <div className="px-4 py-4 flex-1">
        <div className="flex justify-between items-center mb-4">
          <div className="flex flex-col">
            <h4 className="text-lg font-ubuntu">Hotel Booking Lead Time</h4>
            <p className="text-sm font-raleway font-medium">
              Manage minimum booking lead time requirements for hotel reservations and different traveler types
            </p>
          </div>
