...
import CompanySettingsNestedSidebar from "@/components/CompanySettingsNestedSidebar";
    ...
    <>
      <div className="flex items-center justify-between border-b py-2 w-full">
        <div className="flex items-center">
          ...
          <h3 className="uppercase font-semibold">Company Settings</h3>
        </div>
