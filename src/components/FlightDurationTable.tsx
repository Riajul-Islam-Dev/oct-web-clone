...
interface FlightDurationTableProps {
  data: FlightDuration[];
}

export function FlightDurationTable({ data }: FlightDurationTableProps) {
  return (
    <div className="border rounded-lg overflow-hidden" style={{ borderColor: "#e2e8f0" }}>
      ...
      > 
        ...
        <div className="col-span-3">Traveler type</div> 
      ...
      {data.map((duration, index) => ( 
        ...
        > 
          <div className="col-span-3 font-medium text-sm" style={{ color: "#18181a" }}>{duration.policyLevel}</div> 
          <div className="col-span-3 text-sm" style={{ color: "#64748b" }}>{duration.travelerType}</div> 
          <div className="col-span-2 text-sm" style={{ color: "#64748b" }}>{duration.short}</div>
          <div className="col-span-2 text-sm" style={{ color: "#64748b" }}>{duration.long}</div>
