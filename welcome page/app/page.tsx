      ...
      <section className="relative h-96 bg-gray-800 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white space-y-8">
          ...
          <div className="flex items-center justify-center gap-1">
            <Button className="bg-black/80 text-white rounded-full px-6 py-2 text-sm font-medium">
          ...
          {/* Search Bar */}
          <div className="flex items-center max-w-2xl mx-auto bg-white rounded-full p-1 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mx-auto">
                  <BarChart3 className="w-6 h-6 text-[#eda92c]" />
                </div>
                <h3 className="font-semibold text-[#2a2b2f]">Expense Reports</h3>
                <p className="text-sm text-gray-600">Track & submit</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto">
                  <Award className="w-6 h-6 text-[#316db4]" />
                </div>
                <h3 className="font-semibold text-[#2a2b2f]">Corporate Rewards</h3>
                <p className="text-sm text-gray-600">2,250 points</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                <div className="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center mx-auto">
                  <Users className="w-6 h-6 text-[#eda92c]" />
                </div>
                <h3 className="font-semibold text-[#2a2b2f]">Group Travel</h3>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-3">
                ...
                <h3 className="font-semibold text-[#2a2b2f]">Travel Analytics</h3>
